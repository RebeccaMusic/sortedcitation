...
\newcommand\scite[1]{%
	...
	[\csname citeentries\thecitenum.seqno\endcsname]%seq number
	}\fi	%
}
...
In programming, it is crucial to add a \% at the end of a line, otherwise there might be spaces added expectedly.
